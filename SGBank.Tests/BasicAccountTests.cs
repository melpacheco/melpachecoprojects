   ...
   public class BasicAccountTests
    {
        ...
        public void BasicAccountWithdrawlRuleTest(string accountNumber, string Name, decimal balance, AccountType accountType, decimal amount, decimal newBalance, bool expectedResult)
        {
            IWithdraw withdraw = new BasicAccountWithdrawlRule();
